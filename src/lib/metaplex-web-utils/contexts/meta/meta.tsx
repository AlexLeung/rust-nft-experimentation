import {
  ...
  METADATA_PROGRAM_ID,
  toPublicKey,
} from '../../../metaplex-oyster-common/utils/ids';
import { useQuerySearch} from '../../../metaplex-oyster-common/hooks/useQuerySearch';
import { useConnection } from '../../../metaplex-oyster-common/contexts/connection';
import { useStore} from '../../../metaplex-oyster-common/contexts/store';
import React, {
  useCallback,
  useContext,
  useEffect,
